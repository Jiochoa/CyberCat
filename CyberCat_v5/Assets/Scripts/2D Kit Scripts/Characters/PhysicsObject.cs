...
public class PhysicsObject : MonoBehaviour
{
    ...
    // Parent Components
    ControlledCapsuleCollider m_ControlledCollider;
    ...
    void Start()
    {
        ...
        m_ControlledCollider = GetComponentInParent<ControlledCapsuleCollider>();
    }
    ...
    void Update()
    {
        ...
        // Integrate
        grounded = m_ControlledCollider.IsGrounded();
